<?
	...
	switch ($__page_type) {
		...
		case 'delivery_calc':
			...
			$modules = array (
				new TopMenu_UI(),               // Р’РµСЂС…РЅРµРµ РјРµРЅСЋ
				new ModalCart_UI(),				// РЎСЃС‹Р»РєР° Рё РјРѕРґР°Р»СЊРЅР°СЏ С„РѕСЂРјР° РљРѕСЂР·РёРЅС‹
				new ProductScroller_UI(),       // РџСЂРѕРєСЂСѓС‚РєР° "РљР°СЂСѓСЃРµР»СЊ" С‚РѕРІР°СЂРѕРІ
				// Content
				new DeliveryCalc_UI( $p_data ),  //
				// Р›РµРІР°СЏ РєРѕР»РѕРЅРєР°
				null, //new BrandSideMenu_UI(),         // РњРµРЅСЋ РїРѕ Р±СЂРµРЅРґР°Рј
				null, //new AccessoriesSideMenu_UI(),	// РњРµРЅСЋ РїРѕ Р°РєСЃРµСЃСЃСѓР°СЂР°Рј
				new ColumnCart_UI(),            // РњРёРЅРё-С‚Р°Р±Р»РёС†Р° "РљРѕСЂР·РёРЅР°"
				null, //new Newsletter_UI(),            // Р РµРіРёСЃС‚СЂР°С†РёСЏ РЅР° СЂР°СЃСЃС‹Р»РєСѓ РЅРѕРІРѕСЃС‚РµР№ РїРѕ СЌР»РµРєС‚СЂРѕРЅРЅРѕР№ РїРѕС‡С‚Рµ
				null, //new ColumnCompareProducts_UI(), // РњРёРЅРё-С‚Р°Р±Р»РёС†Р° "РЎСЂР°РІРЅРµРЅРёРµ С‚РѕРІР°СЂРѕРІ"
				// РџРѕРґРІР°Р» в„– 1
				new ProductFooterViewed_UI(),   // РџРѕСЃР»РµРґРЅРёРµ РїСЂРѕСЃРјРѕС‚СЂРµРЅРЅС‹Рµ С‚РѕРІР°СЂС‹ 
				null, //new BrandFooterViewed_UI(),     // Р‘СЂСЌРЅРґС‹
				// РџРѕРґРІР°Р» в„– 2
				new NewFooterList_UI(),         // РЎРїРёСЃРѕРє "РќРѕРІРёРЅРєРё" (РїРѕ РґР°С‚Рµ РїСѓР±Р»РёРєР°С†РёРё РІ РјР°РіР°Р·РёРЅРµ)
				new BestsellerFooterList_UI(),  // РЎРїРёСЃРѕРє "РЎР°РјС‹Рµ РїРѕРєСѓРїР°РµРјС‹Рµ С‚РѕРІР°СЂС‹"
				new PopularFooterList_UI(),     // РЎРїРёСЃРѕРє "РЎР°РјС‹Рµ РїРѕРїСѓР»СЏСЂРЅС‹Рµ С‚РѕРІР°СЂС‹"
				// РџРѕРґРІР°Р»СЊРЅРѕРµ РјРµРЅСЋ
				new FooterMenu_UI()             // 
			);

			// Р“РµРЅРµСЂР°С‚РѕСЂ СЃС‚СЂР°РЅРёС†С‹	
