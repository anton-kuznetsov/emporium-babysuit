...
class ShopingCart_UI extends UI {
	...
	public function render() {
		...
		$data['shipment'] = array(
			'russian_post' => array( 'total' => 0, 'total_str' => '', 'max_weight' => Shipping::MaxWeight(1) ),
			'ems'          => array( 'total' => 0, 'total_str' => '', 'max_weight' => Shipping::MaxWeight(2) ),
		);
		...
		$data['shipment']['russian_post']['total'] = 114.46 + (ceil($weight / 100) - 1) * 17.11;
